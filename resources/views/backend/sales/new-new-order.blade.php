    ...
    <div class="row">
        <div class="col-lg-10 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('feat-order.store') }}" method="POST">
                        @csrf
                                ...
                                <div class="form-group row col-4">
                                    <div class="col-4">
                                        <label class="control-label"
                                            for="rep">{{ translate('Representative') }}</label>
                                    </div>
                                    <div style="width: 100%;">
                                        <select name="rep_id" id="rep" class="form-control rep-search" required
                                            data-placeholder="{{ translate('Choose User') }}" data-live-search="true"
                                            data-selected-text-format="count">
                                            <option></option>
                                            @foreach (\App\Models\User::where('is_rep', 1)->orderBy('name', 'desc')->get() as $user)
                    ...
                    <table class="table" id="order-table">
                        ...
                        <tbody>
                            <tr class="order-row">
                                ...
                                <td contenteditable="true" class="product-qty" dir="ltr">1</td>
                                <td class="product-unit" style="width: 8rem; min-width: 8rem; max-width: 8rem;">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function initialDate() {
                ...
                //         $(this).val(defaultDate); // Reset to default if a different year is selected
                //     }
                // });
            }
            ...
            // $(document).on('keydown', '.unit-toggle', function(e) {
            ...
            //     if (e.key === "Tab") {
            //         e.preventDefault();
            //         $(this).closest('.order-row').find('.product-price')[0].focus();
            //     }
            // });
