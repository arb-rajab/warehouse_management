            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @canany(['add_new_product', 'show_all_products', 'show_in_house_products', 'show_seller_products',
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endcan
                            @if (Auth::user()->raizer_admin == true || get_setting('In_House_Products_Section') == '1')
                            ...
                            @if (Auth::user()->raizer_admin == true || get_setting('vendor_system_activation') == '1')
                            ...
                            @if (Auth::user()->raizer_admin == true || get_setting('Digital_Products_Section') == '1')
                            ...
                            @endcan
                            @can('set_brand_wise_discount')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('brands_wise_product_discount') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Brand Based Discount') }}</span>
                                    </a>
                                </li>
                            @endcan
                            ...
                            @if (Auth::user()->raizer_admin == true || get_setting('Product_Reviews_Section') == '1')
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            @can('view_all_orders')
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('feat-order.create') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['all_orders.index', 'all_orders.show', 'feat-order.create']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Create Order') }}</span>
                                    </a>
                                </li>
                            @endcan
                            @if (Auth::user()->raizer_admin == true || get_setting('In_House_Orders_Section') == 1)
                            ...
                            @if (Auth::user()->raizer_admin == true || get_setting('Pickup_Orders_Section') == 1)
                            ...
                            @can('view_all_customers')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('customers.create') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Customer Create') }}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('view_all_customers')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('customers.archive') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Customer Archive') }}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('view_all_customers')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('admin.notifications.all') }}" class="aiz-side-nav-link">
                ...
                @canany(['view_all_customers', 'view_classified_products', 'view_classified_packages'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-user-friends aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Representatives') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            @can('view_all_customers')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('representatives.index') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Representatives list') }}</span>
                                    </a>
                                </li>
                            @endcan
                            {{-- <li class="aiz-side-nav-item">
                                <a href="{{ route('representatives.create') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Add New Representative') }}</span>
                                </a>
                            </li> --}}

                            <li class="aiz-side-nav-item">
                                <a href="{{ route('rep.packages.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Representatives Packages') }}</span>
                                </a>
                            </li>

                            <li class="aiz-side-nav-item">
                                <a href="{{ route('admin.rep.payments.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Representatives Payments') }}</span>
                                </a>
                            </li>

                            <li class="aiz-side-nav-item">
                                <a href="{{ route('admin.rep.visits.index') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['admin.rep.visits.index', 'admin.rep.visits.show']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Representatives Visits') }}</span>
                                </a>
                            </li>
                    ...
                    @canany(['view_all_seller', 'seller_payment_history', 'view_seller_payout_requests',
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                @endcan
                                @if (Auth::user()->raizer_admin == true || get_setting('Payouts_Section') == 1)
                                ...
                                @if (Auth::user()->raizer_admin == true || get_setting('Payout_request_Section') == 1)
                                ...
                                @if (Auth::user()->raizer_admin == true || get_setting('Seller_Commission_Section') == 1)
                                ...
                                @if (Auth::user()->raizer_admin == true || get_setting('Seller_Verify_Form_Section') == 1)
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <i class="las la-suitcase aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Trips') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="javascript:void(0);" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Trucks') }}</span>
                                <span class="aiz-side-nav-arrow"></span>
                            </a>
                            <ul class="aiz-side-nav-list level-3">
                                {{-- @can('facebook_chat') --}}
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('trucks.index') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('All Trucks') }}</span>
                                    </a>
                                </li>
                                {{-- @endcan --}}
                                {{-- @can('facebook_comment') --}}
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('trucks.create') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Create Truck') }}</span>
                                    </a>
                                </li>
                                {{-- @endcan --}}
                            </ul>
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-3">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('trips.index') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('All Trips') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('trips.today-trips') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Today Trips') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('trips.create') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Create Trip') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('trips.create-from-map') }}" class="aiz-side-nav-link">
                                        <span
                                            class="aiz-side-nav-text">{{ translate('Create Trip From The Map') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('trips.orders') }}" class="aiz-side-nav-link">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="javascript:void(0);" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Drivers') }}</span>
                                <span class="aiz-side-nav-arrow"></span>
                            </a>
                            <ul class="aiz-side-nav-list level-3">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('drivers.index') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('All Drivers') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('drivers.create') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Create driver') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ env('APP_URL') . '/admin/website/custom-pages/edit/home?page=home' }}"
                        class="aiz-side-nav-link">
                        <i class="las la-folder-open aiz-side-nav-icon"></i>
                ...
                @if (Auth::user()->raizer_admin == true || get_setting('Order_configuration_section') == 1)
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('offers.index') }}" class="aiz-side-nav-link">
                        <i class="las la-folder-open aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Offers Catalog') }}</span>
                    </a>
                </li>

                <!-- Reports -->
                @if (Auth::user()->raizer_admin == true || get_setting('Reports_Section') == 1)
                    @canany(['in_house_product_sale_report', 'seller_products_sale_report', 'products_stock_report',
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                @if (Auth::user()->raizer_admin == true || get_setting('In_House_Sales_Report') == 1)
                                ...
                                @if (Auth::user()->raizer_admin == true || get_setting('Products_Stock_Report') == 1)
                                ...
                                @if (Auth::user()->raizer_admin == true || get_setting('Products_Wishlist_Report') == 1)
                                ...
                                @if (Auth::user()->raizer_admin == true || get_setting('User_Searches_Report') == 1)
                                ...
                                @if (Auth::user()->raizer_admin == true || get_setting('Commission_History_Report') == 1)
                                ...
                                @if (Auth::user()->raizer_admin == true || get_setting('Wallet_Recharge_History') == 1)
                ...
                <!--Blog System-->
                @if (Auth::user()->raizer_admin == true || get_setting('Blog_Section') == 1)
                ...
                <!-- marketing -->
                @if (Auth::user()->raizer_admin == true || get_setting('Marketing_Section') == 1)
                    @canany(['view_all_flash_deals', 'send_newsletter', 'send_bulk_sms', 'view_all_subscribers',
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                @if (Auth::user()->raizer_admin == true || get_setting('Flash_deals') == 1)
                                    ...
                                    @endcan
                                @endif
                                @if (Auth::user()->raizer_admin == true || get_setting('Offer_deals') == 1)
                                    @can('view_all_offer_deals')
                                        <li class="aiz-side-nav-item">
                                            <a href="{{ route('offer_deals.index') }}"
                                                class="aiz-side-nav-link {{ areActiveRoutes(['offer_deals.index', 'offer_deals.create', 'offer_deals.edit']) }}">
                                                <span class="aiz-side-nav-text">{{ translate('Offer deals') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                @endif
                                ...
                                @if (Auth::user()->raizer_admin == true || get_setting('Newsletters') == 1)
                                    @can('send_newsletter')
                                        <li class="aiz-side-nav-item">
                                ...
                                @if (Auth::user()->raizer_admin == true ||
                                        (get_setting('coupon_system') == 1 && auth()->user()->can('view_all_coupons')))
                                    <li class="aiz-side-nav-item">
                ...
                <!-- Support -->
                @if (Auth::user()->raizer_admin == true || get_setting('Support_Section') == '1')
                    @canany(['view_all_support_tickets', 'view_all_product_conversations', 'view_all_product_queries'])
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                @endcan
                                @if (Auth::user()->raizer_admin == true || get_setting('conversation_system') == 1)
                                ...
                                @if (Auth::user()->raizer_admin == true || get_setting('product_query_activation') == 1)
                ...
                <!-- Website Setup -->
                @if (get_setting('website_setup') == 1 || Auth::user()->raizer_admin == true)
                    @canany(['header_setup', 'footer_setup', 'view_all_website_pages', 'website_appearance'])
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                @can('header_setup')
                                    @if (get_setting('website_setup_header') == 1 || Auth::user()->raizer_admin == true)
                                        <li class="aiz-side-nav-item">
                                ...
                                @can('footer_setup')
                                    @if (get_setting('website_setup_footer') == 1 || Auth::user()->raizer_admin == true)
                                        <li class="aiz-side-nav-item">
                                ...
                                @can('view_all_website_pages')
                                    @if (get_setting('website_setup_pages') == 1 || Auth::user()->raizer_admin == true)
                                        <li class="aiz-side-nav-item">
                                ...
                                @can('website_appearance')
                                    @if (get_setting('website_setup_appearance') == 1 || Auth::user()->raizer_admin == true)
                                        <li class="aiz-side-nav-item">
                ...
                @if (Auth::user()->raizer_admin == true || get_setting('Setup_configuration_section') == 1)
                    @canany(['general_settings', 'features_activation', 'language_setup', 'currency_setup',
                        ...
                        'google_map_setting', 'google_firebase_setting', 'shipping_configuration',
                        'shipping_country_setting', 'manage_shipping_states', 'manage_shipping_cities', 'manage_zones',
                        'manage_carriers'])
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                @if (Auth::user()->raizer_admin == true || get_setting('Languages_section') == 1)
                                    @can('language_setup')
                                        <li class="aiz-side-nav-item">
                                ...
                                @if (Auth::user()->raizer_admin == true || get_setting('currency_section') == 1)
                                    @can('currency_setup')
                                        <li class="aiz-side-nav-item">
                                ...
                                @if (Auth::user()->raizer_admin == true || get_setting('VAT_TAX_section') == 1)
                                    @can('vat_&_tax_setup')
                                        <li class="aiz-side-nav-item">
                                ...
                                @if (Auth::user()->raizer_admin == true || get_setting('Setup_pickup_point_section') == 1)
                                ...
                                @if (Auth::user()->raizer_admin == true || get_setting('SMTP_Section') == 1)
                                    @can('smtp_settings')
                                        <li class="aiz-side-nav-item">
                                ...
                                @if (Auth::user()->raizer_admin == true || get_setting('Socail_Media_logins_section') == 1)
                    ...
                    @if (Auth::user()->raizer_admin == true || get_setting('Facebook_section') == 1)
                        @canany(['facebook_chat', 'facebook_comment'])
                            <li class="aiz-side-nav-item">
                                <a href="javascript:void(0);" class="aiz-side-nav-link">
                    ...
                    @if (Auth::user()->raizer_admin == true || get_setting('Setup_Shipping_section') == 1)
                ...
                @if (Auth::user()->raizer_admin == true || get_setting('Staffs_section') == 1)
