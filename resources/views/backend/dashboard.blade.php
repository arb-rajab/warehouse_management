    ...
    <div class="col-lg-6">
        <div class="row gutters-10">
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-header">
                        <h6 class="mb-0 fs-14">{{ translate('Products Source') }}</h6>
                    </div>
                    <div class="card-body">
...
<div class="row gutters-10">
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0 fs-14">{{ translate('Total visits on the website') }}</h6>
            </div>
            <div class="card-body">
...
<script type="text/javascript">
    AIZ.plugins.chart('#pie-1',{
        ...
        data: {
            labels: [
                ...
                '{{translate('Total active products')}}',
    ...
    AIZ.plugins.chart('#pie-2',{
        ...
        data: {
            ...
            datasets: [
                {
                    data: [
                        {{ \App\Models\Product::where('from_api', 1)->count() }},
                        {{ \App\Models\Product::where('from_api', 0)->count() }}
    ...
    AIZ.plugins.chart('#graph-3',{
        ...
        data: {
            ...
            datasets: [{
                label: '{{ translate('Number of visits') }}',
                data: [
                    {{ $cached_graph_data['num_of_visits_data'] }}
                ],
                backgroundColor: [
                    @foreach ($total_visits as $country => $total_visit)
                        'rgba(55, 125, 25, 0.4)',
