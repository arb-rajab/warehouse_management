<div class="aiz-user-sidenav-wrap position-relative z-1 rounded-0">
    <div class="aiz-user-sidenav overflow-auto c-scrollbar-light px-4 pb-4">
        ...
        <div class="p-4 text-center mb-4 border-bottom position-relative">
            ...
            <h4 class="h5 fs-14 mb-2 fw-700 text-danger">{{ Auth::user()->AccSysID }}</h4>
            <!-- Phone -->
        ...
        <div class="sidemnenu">
            <ul class="aiz-side-nav-list mb-3 pb-3 border-bottom" data-toggle="aiz-side-menu">
                ...
                @if (auth()->user()->is_rep)
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('payments.index') }}"
                            ...
                            <span class="aiz-side-nav-text ml-3">{{ translate('Representative Payments') }}</span>
                            @if ($delivery_viewed > 0 || $payment_status_viewed > 0)
                                <span class="badge badge-inline badge-success">{{ translate('New') }}</span>
                            @endif
                        </a>
                ...
                @if (auth()->user()->is_rep)
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('create_customer') }}"
                            class="aiz-side-nav-link {{ areActiveRoutes(['create_customer']) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            ...
                            <span class="aiz-side-nav-text ml-3">{{ translate('Add Customer') }}</span>
                        </a>
                    </li>
                @endif
                ...
                <!-- Followed Sellers -->
                @if(get_setting('vendor_system_activation'))
                <li class="aiz-side-nav-item">
                ...
                <!-- Support Ticket -->
                @if(get_setting('Support_Section') == 1)
                <li class="aiz-side-nav-item">
                ...
                @if(get_setting('qr_connection_system') == 1)
                <!-- Generate QR -->
                <li class="aiz-side-nav-item">
                    <a href="{{ route('create.personalInfo') }}" class="aiz-side-nav-link {{ areActiveRoutes(['create.personalInfo']) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            <g id="Group_8094" data-name="Group 8094" transform="translate(3176 -602)">
                              <path id="Path_2924" data-name="Path 2924" d="M331.144,0a4,4,0,1,0,4,4,4,4,0,0,0-4-4m0,7a3,3,0,1,1,3-3,3,3,0,0,1-3,3" transform="translate(-3499.144 602)" fill="#b5b5bf"/>
                              <path id="Path_2925" data-name="Path 2925" d="M332.144,20h-10a3,3,0,0,0,0,6h10a3,3,0,0,0,0-6m0,5h-10a2,2,0,0,1,0-4h10a2,2,0,0,1,0,4" transform="translate(-3495.144 592)" fill="#b5b5bf"/>
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('Create QR') }}</span>
                    </a>
                </li>

                 <!-- My Connections -->
                 <li class="aiz-side-nav-item">
                    <a href="{{ route('show.connections', ['user_id' => auth()->user()->id]) }}" class="aiz-side-nav-link {{ areActiveRoutes(['show.connections']) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            <g id="Group_8094" data-name="Group 8094" transform="translate(3176 -602)">
                              <path id="Path_2924" data-name="Path 2924" d="M331.144,0a4,4,0,1,0,4,4,4,4,0,0,0-4-4m0,7a3,3,0,1,1,3-3,3,3,0,0,1-3,3" transform="translate(-3499.144 602)" fill="#b5b5bf"/>
                              <path id="Path_2925" data-name="Path 2925" d="M332.144,20h-10a3,3,0,0,0,0,6h10a3,3,0,0,0,0-6m0,5h-10a2,2,0,0,1,0-4h10a2,2,0,0,1,0,4" transform="translate(-3495.144 592)" fill="#b5b5bf"/>
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('My Connections') }}</span>
                    </a>
                </li>
                @endif
