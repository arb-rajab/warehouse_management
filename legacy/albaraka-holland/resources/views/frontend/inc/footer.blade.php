...
<section class="py-lg-3 text-light footer-widget" style="background-color: #212129 !important;">
    ...
    <div class="container d-none d-lg-block">
        ...
        <div class="row">
            ...
            <div class="{{ $col_values }}">
                <iframe src="{{ get_setting('google_maps_link') }}" width="350" height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
                ...
                <div class="text-center text-sm-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                            ...
                            <a class="fs-13 text-soft-light animate-underline-white" href="{{ get_setting('play_store_link') }}" target="_blank">
                                {{ translate('Download our application') }}
                            </a>
                        </li>
                        @if (get_setting('play_store_link'))
                            <li class="mb-2">
                                <div style="border: 5px solid #ffffff; display: inline-block;">
                                    {{ \QrCode::size(150)->generate(get_setting('play_store_link')) }}
                                </div>
                            </li>
                        @endif
