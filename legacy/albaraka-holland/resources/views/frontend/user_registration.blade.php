                                        ...
                                        <div class="">
                                            <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control rounded-0{{ $errors->has('company_name') ? ' is-invalid' : '' }}" value="{{ old('company_name') }}" placeholder="{{  translate('Company name') }}" name="company_name">
                                                ...
                                                <div class="form-group">
                                                    <label for="phone" class="fs-12 fw-700 text-soft-dark">{{  translate('phone') }}</label>
                                                    <input type="tel" class="form-control rounded-0{{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ old('phone') }}" placeholder="{{  translate('phone') }}" name="phone">
                                                    @if ($errors->has('phone'))
                                                        <span class="invalid-feedback" role="alert">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control rounded-0{{ $errors->has('tax_number') ? ' is-invalid' : '' }}" value="{{ old('tax_number') }}" placeholder="{{  translate('Tax Number') }}" name="tax_number">
                                                ...
                                                {{-- <!-- Bank Account Number -->
                                                <div class="form-group">
                                                    <label for="bank_account_number" class="fs-12 fw-700 text-soft-dark">{{  translate('Bank Account Number') }}</label>
                                                    <input type="text" class="form-control rounded-0{{ $errors->has('bank_account_number') ? ' is-invalid' : '' }}" value="{{ old('bank_account_number') }}" placeholder="{{  translate('Bank Account Number') }}" name="bank_account_number">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control rounded-0{{ $errors->has('company_address') ? ' is-invalid' : '' }}" value="{{ old('company_address') }}" placeholder="{{  translate('Company Address') }}" name="company_address">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control rounded-0{{ $errors->has('shipping_address') ? ' is-invalid' : '' }}" value="{{ old('shipping_address') }}" placeholder="{{  translate('Shipping Address') }}" name="shipping_address">
                                                ...
                                                {{-- <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control rounded-0{{ $errors->has('trade_license') ? ' is-invalid' : '' }}" value="{{ old('trade_license') }}" placeholder="{{  translate('Upload Trade License') }}" name="trade_license">
                                                ...
                                                <div class="modal fade" id="terms_conditions_modal" tabindex="-1" role="dialog" aria-labelledby="account_delete_confirmModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                                        <div class="modal-content pb-2" style="max-height: 90vh; overflow-y: auto;">
