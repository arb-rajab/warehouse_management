<table class="table table-bordered aiz-table">
    <thead>
        <tr>
            ...
            <td data-breakpoints="lg" width="20%">
                <span>{{ translate('Company Address') }}</span>
            </td>
            <td data-breakpoints="lg" width="20%">
    ...
    <tbody>
        ...
        <tr>
            <td>
                <span class="badge badge-inline badge-{{ $is_rep ? 'success' : 'info' }}">{{ $user->name }}</span>
            </td>
            <td>
                <span>{{ $user->AccSysID }}</span>
            </td>
            <td>
                <span>{{ $is_rep ? $user->rep_serial : $user->member_serial }}</span>
            </td>
            <td>
...
{{-- <table class="table table-bordered aiz-table">
    ...
    <tbody>
        @php
            $user = \App\Models\User::findOrFail($rep_id);
            $is_rep = $user->is_rep;
        @endphp
        <tr>
            <td>
