                                        ...
                                        <div class="media text-inherit">
                                            <div class="media-body">
                                                @if($notification->type == 'App\Notifications\OrderNotification')
                                                    ...
                                                    @elseif ($notification->type == 'App\Notifications\UnorderedCartNotification')
                                                    <p class="mb-1 text-truncate-2">
                                                        <a href="{{route('customers.whatsapp_contact', $notification->data['user_id'])}}" class="text-secondary fs-12">
                                                            <span class="">
