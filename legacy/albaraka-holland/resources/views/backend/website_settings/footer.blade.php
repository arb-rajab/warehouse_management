    ...
    <div class="card">
        ...
        <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
           ...
           <div class="card-body">
				...
				<!-- Registration tutorial button -->
                <div class="card shadow-none bg-light">
                  	<div class="card-header">
						<h6 class="mb-0">{{ translate('Registration tutorial button') }}</h6>
					</div>
					<div class="card-body">
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Show Registration tutorial button?')}}</label>
                            <div class="col-md-9">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                <input type="hidden" name="types[]" value="registration_tutorial_button">
                                <input type="checkbox" name="registration_tutorial_button" @if( get_setting('registration_tutorial_button')) checked @endif>
                                <span></span>
                                </label>
                            </div>
                        </div>
						<div class="form-group">
							<div class="input-group form-group">
                                <input type="hidden" name="types[]" value="registration_tutorial_text">
                                <input type="text" class="form-control" placeholder="Example: Click Here!" name="registration_tutorial_text" value="{{ get_setting('registration_tutorial_text')}}">
                            </div>
							<div class="input-group form-group">
                                <input type="hidden" name="types[]" value="registration_tutorial_link">
                                <input type="text" class="form-control" placeholder="http://" name="registration_tutorial_link" value="{{ get_setting('registration_tutorial_link')}}">
                            </div>
						</div>
					</div>
                </div>
