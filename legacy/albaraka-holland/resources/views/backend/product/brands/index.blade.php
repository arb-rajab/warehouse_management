			...
			<div class="card">
				...
				<div class="card-body">
					<form action="{{ route('brands.store') }}" method="POST">
						...
						<div class="form-group mb-3">
							<label for="order_level">{{translate('Order Level')}}</label>
							<input type="number" placeholder="{{translate('Order Level')}}" name="order_level" class="form-control" required>
						</div>
						<div class="form-group mb-3">
