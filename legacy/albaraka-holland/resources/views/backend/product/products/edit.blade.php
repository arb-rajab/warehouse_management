            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Otajer Image')}}</label>
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse')}}</div>
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                    <input type="hidden" name="old_photo" value="{{ $product->old_photo }}" class="selected-files">
                                </div>
                                <div class="file-preview box sm">
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{ translate('Product Types') }}</h5>
                    </div>
                    <div class="card-body">
                        <div id="variations">
                            <div class="variation row" style="display: none">
                                <div class="col-6">
                                <input class="form-control my-2" name="product_types[]" type="text" placeholder="Type">
                                </div>
                                <div class="col-3">
                                <button type="button" class="remove-variation my-2 btn btn-danger action-btn">Remove</button>
                                </div>
                            </div>
                            ...
                            @if($variations)
                                ...
                                <div class="variation row" >
                                    <div class="col-6">
                                    <input class="form-control my-2" name="product_types[]" type="text" value="{{ $variation->name }}" placeholder="Type">
                                    </div>
                                    <div class="col-3">
                                    <button type="button" class="remove-variation my-2 btn btn-danger action-btn">Remove</button>
                                    </div>
                        ...
                        <button type="button" class="btn btn-primary action-btn" id="add-variation">Add Type</button>
                    </div>
                </div>

                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{ translate('Product Barcodes') }}</h5>
                    </div>
                    <div class="card-body">
                        <div id="barcodes">
                            <div class="barcode row" style="display: none">
                                <div class="col-6">
                                <input class="form-control my-2" name="product_barcodes[]" type="text" placeholder="Barcode Number">
                                </div>
                                <div class="col-3">
                                <button type="button" class="remove-barcode my-2 btn btn-danger action-btn">Remove</button>
                                </div>
                            </div>
                            ...
                            @if($barcodes)
                                ...
                                <div class="barcode row" >
                                    <div class="col-6">
                                        <input class="form-control my-2" name="product_barcodes[]" type="text" value="{{ $barcode->barcode }}" placeholder="Type">
                                    </div>
                                    <div class="col-3">
                                        <button type="button" class="remove-barcode my-2 btn btn-danger action-btn">Remove</button>
                                    </div>
                        ...
                        <button type="button" class="btn btn-primary action-btn" id="add-barcode">Add Barcode</button>
                    </div>
                </div>
...
$(document).ready(function () {
    $("#add-variation").click(function () {
        ...
        var newVariation = $(".variation:hidden").first().clone(); // Clone the first variation field
        newVariation.show();

        newVariation.find("input").val(""); // Clear input value
        newVariation.appendTo("#variations"); // Append the new variation to the variations section
    });

    $(document).on("click", ".remove-variation", function () {
        $(this).closest(".variation").remove(); // Remove the clicked variation
    });

    $("#add-barcode").click(function () {

        var newBarcode = $(".barcode:hidden").first().clone();
        newBarcode.show();

        newBarcode.find("input").val("");
        newBarcode.appendTo("#barcodes");
    });

    $(document).on("click", ".remove-barcode", function () {
        $(this).closest(".barcode").remove();
    });
});
