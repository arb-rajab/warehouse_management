                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="number" lang="en" class="form-control" name="max_qty" value="1000" min="1" required>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="card-body">
                        <div id="variations">
                            ...
                            {{-- <div class="variation row">
                                    <div class="col-6">
                                        <input class="form-control my-2" type="text" name="variation_value[]" placeholder="Type">
                                    </div>
                                    <div class="col-3">
                                        <button type="button" class="remove-variation my-2 btn btn-danger action-btn">Remove</button>
                                    </div>
...
<!--                <div class="card">
            ...
            <div class="col-lg-4">
                @if(get_setting('Setup_Shipping_section'))
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">
 ...
 <input type="hidden" name="cash_on_delivery" value="1">
                ...
                @if(get_setting('Setup_Shipping_section') == 1)
                <div class="card">
                    <div class="card-header">
                ...
                @if(get_setting('VAT_TAX_section') == 1)
                <div class="card">
                    <div class="card-header">
