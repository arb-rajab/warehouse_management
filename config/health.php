...
return [
    ...
    'result_stores' => [
        EloquentHealthResultStore::class => [
            'connection' => env('HEALTH_DB_CONNECTION', 'health'),
    ...
    /*
     * Comma-separated list of IPs (wildcards like 10.0.0.* supported) allowed to reach the
     * /health dashboard, enforced by App\Http\Middleware\RestrictToAllowedIps. Defaults to
     * the same list as Telescope; set HEALTH_ALLOWED_IPS to diverge from it. Empty disables
     * this check, leaving the viewHealth gate as the only guard.
     */
    'allowed_ips' => env('HEALTH_ALLOWED_IPS', env('TELESCOPE_ALLOWED_IPS', '')),
