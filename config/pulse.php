...
return [
    ...
    */
    ...
    'middleware' => [
        'web',
        Authorize::class,
        RestrictToAllowedIps::class.':pulse.allowed_ips',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Comma-separated list of IPs (wildcards like 10.0.0.* supported) allowed
    | to reach Pulse, enforced by RestrictToAllowedIps. Defaults to the same
    | list as Telescope; set PULSE_ALLOWED_IPS to diverge from it. Empty
    | disables this check, leaving the viewPulse gate as the only guard.
    |
    */

    'allowed_ips' => env('PULSE_ALLOWED_IPS', env('TELESCOPE_ALLOWED_IPS', '')),
