...
class SearchController extends Controller
{
    public function index(Request $request, $category_id = null, $brand_id = null)
    {
        ...
        if ($category_id != null) {
            ...
            $products->whereIn('category_id', $category_ids)->orderBy('published', 'desc')->orderBy('featured', 'desc');
        ...
        $products = filter_products($products)->with('taxes')->paginate(120)->appends(request()->query());
    ...
    public function search_users(Request $request)
    {
        ...
        if(!$query){
            $users = User::where('id', '!=', Auth::user()->id)->where('is_rep', false)->take(10)->get();
