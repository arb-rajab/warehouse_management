...
| database/migrations/**,config/database.php,config/permission.php,config/session.php,config/cache.php,config/queue.php,config/auth.php,app/Models/PersonalAccessToken.php,app/Models/Product.php,app/Providers/AppServiceProvider.php,resources/js/lib/productName.ts,resources/js/components/ProductOptionLabel.vue | .ai/rules/shared-database.md |
